...
export default function PasswordGenerator() {
  ...
  const [password, setPassword] = useState(() =>
    generatePassword(16, { uppercase: true, lowercase: true, numbers: true, symbols: false, excludeAmbiguous: false })
  );
  ...
  const optionItems = [
    ...
    { key: "excludeAmbiguous" as const, label: "Exclude Mirip", desc: "0O1lI|`" },
  ];
